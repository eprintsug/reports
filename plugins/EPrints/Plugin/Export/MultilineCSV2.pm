...
EPrints::Plugin::Export::MultilineCSV2

=cut

package EPrints::Plugin::Export::MultilineCSV2;

use EPrints::Plugin::Export;
use EPrints::Plugin::Export::Grid2;

@ISA = ( "EPrints::Plugin::Export::Grid2" );
